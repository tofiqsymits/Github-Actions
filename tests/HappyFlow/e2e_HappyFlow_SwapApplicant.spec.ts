...
test.describe(`--- HAPPYFLOW SWAPPING STAGES ---`, () => {
    ...
    test.describe(`--- Internal Questionnaire E2E - Suit ---`, () => {
        ...
        test(`Swap Applicant to "${INTERNAL_QUESTIONNAIRE_E2E_Stage}" Stage`, async ({ browserName }) => {
            const POM = new POManager(page);

            await test.step(`Swapping Applicant : "${APPLICANT_NAME_to_be_swap}" to "${INTERNAL_QUESTIONNAIRE_E2E_Stage}" Stage... via \x1b[32m[${browserName}]\x1b[0m`, async () => {
                await POM._applicantpagewv.swapApplicant_workflowview_by_name(APPLICANT_NAME_to_be_swap, INTERNAL_QUESTIONNAIRE_E2E_Stage);
            })
            ...
            await test.step(`Validating Applicant's Stage is Changed to "${INTERNAL_QUESTIONNAIRE_E2E_Stage}"... via \x1b[32m[${browserName}]\x1b[0m`, async () => {
                await expect(page.locator(
                    POM._applicantpagewv.prefix_specific_ApplicantName_full_div
                    + APPLICANT_NAME_to_be_swap
                    + POM._applicantpagewv.suffix_specific_ApplicantName_full_div
    ...
    test.describe(`--- External Questionnaire E2E - Suit ---`, () => {
        ...
        test(`Swap Applicant to "${EXTERNAL_QUESTIONNAIRE_E2E_Stage}" Stage`, async ({ browserName }) => {
            const POM = new POManager(page);

            await test.step(`Swapping Applicant : "${APPLICANT_NAME_to_be_swap}" to "${EXTERNAL_QUESTIONNAIRE_E2E_Stage}" Stage... via \x1b[32m[${browserName}]\x1b[0m`, async () => {
                await POM._applicantpagewv.swapApplicant_workflowview_by_name(APPLICANT_NAME_to_be_swap, EXTERNAL_QUESTIONNAIRE_E2E_Stage);
            })
            ...
            await test.step(`Validating Applicant's Stage is Changed to "${EXTERNAL_QUESTIONNAIRE_E2E_Stage}"... via \x1b[32m[${browserName}]\x1b[0m`, async () => {
                await expect(page.locator(
                    POM._applicantpagewv.prefix_specific_ApplicantName_full_div
                    + APPLICANT_NAME_to_be_swap
                    + POM._applicantpagewv.suffix_specific_ApplicantName_full_div
                    + POM._applicantpagewv.prefix_specific_ApplicantName_specific_StageName
                    + EXTERNAL_QUESTIONNAIRE_E2E_Stage
                    + POM._applicantpagewv.suffix_specific_ApplicantName_specific_StageName
                )).toBeVisible();
            })
